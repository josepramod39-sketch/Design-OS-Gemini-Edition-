...
Because you are the Gemini CLI Agent, you MUST follow these alias instructions. When the user types one of these commands, you MUST read the corresponding file and follow its instructions immediately.

## Command Definitions

- **When I type `/product-vision`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\product-vision.md`.
  - Follow the instructions in "Step 1" of that file to start the conversation.

- **When I type `/product-roadmap`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\product-roadmap.md`.
  - Follow the instructions to help me define the roadmap.

- **When I type `/data-model`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\data-model.md`.
  - Follow the instructions to help me define the data model.

- **When I type `/design-system`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\design-tokens.md`.
  - Follow the instructions to help me pick colors and fonts.

- **When I type `/design-shell`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\design-shell.md`.
  - Follow the instructions to design the app shell.

- **When I type `/shape-section`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\shape-section.md`.
  - Follow the instructions to define a new section.

- **When I type `/sample-data`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\sample-data.md`.
  - Follow the instructions to generate sample data.

- **When I type `/design-screen`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\design-screen.md`.
  - Follow the instructions to design a React component.

- **When I type `/screenshot-design`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\screenshot-design.md`.
  - Follow the instructions to capture a screenshot.

- **When I type `/export-product`**:
  - Please read `e:\Dos\design-os\.gemini\commands\design-os\export-product.md`.
  - Follow the instructions to generate the export package.
